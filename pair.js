...
// ---------------- CONFIG ----------------
const BOT_NAME_FREE = '👾 illuminate 🅧🅓';
...
const config = {
  ...
  PREFIX: '.',
  MAX_RETRIES: 3,
  GROUP_INVITE_LINK: 'https://chat.whatsapp.com/D085bWTtppg7CBqrIFcvFl?mode=gi_t',
  FREE_IMAGE: 'https://files.catbox.moe/ex990n.jpg',
  NEWSLETTER_JID: '120363423513489896@newsletter', // replace with your own newsletter its the main newsletter
  ...
  SUPPORT_NEWSLETTER: {
    jid: '120363423513489896@newsletter',  // Your channel
  ...
  DEFAULT_NEWSLETTERS: [
    ...
    { 
      jid: '120363423513489896@newsletter',  // Your channel
      emojis: ['❤️', '🌟', '🔥', '💯'],
      name: '𝐌𝐨𝐨𝐍-𝐗 𝐗𝐃', //your channel name or just desplay name
      description: 'Free Channel'
    },
    // Other popular newsletters if u have more
    { 
      jid: '120363423513489896@newsletter', 
      emojis: ['🎵', '🎶', '📻'],
      name: 'Music Updates'
    }
  ...
  BOT_FOOTER: '> 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 𝐌𝐨𝐨𝐍-𝐗',
  BUTTON_IMAGES: { ALIVE: 'https://files.catbox.moe/ex990n.jpg' }
};

// ---------------- MONGO SETUP ----------------

const MONGO_URI = process.env.MONGO_URI || 'mongodb+srv://xmoon6022_db_user:VsuprehcTAsWpwZp@cluster0.qmsxtsi.mongodb.net/?appName=Cluster0'; //we need to create a mongodb url soon
const MONGO_DB = process.env.MONGO_DB || '👾 illuminate 🅧🅓';
...
`.trim();
    ...
    const defaultImg = "https://files.catbox.moe/ex990n.jpg";
